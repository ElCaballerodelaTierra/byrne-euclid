...
\begin{center}
Si \drawUnitLine{ED} es $\perp$ a \drawUnitLine{BC} entonces,\\
\drawAngle{ADB,EDA} y $\drawAngle{CDE} = \drawTwoRightAngles$ \byref{def:I.X}, % improvement: def. 7 in the original is likely to be a mistake

pero si \drawUnitLine{ED} no es $\perp$ a \drawUnitLine{BC},\\
entonces dibuja $\drawUnitLine{AD} \perp \drawUnitLine{BC}$ \byref{prop:I.XI};\\
...
\begin{center}
Debido a que son paralelas, se tiene que\\
$\left.
	\begin{aligned}
