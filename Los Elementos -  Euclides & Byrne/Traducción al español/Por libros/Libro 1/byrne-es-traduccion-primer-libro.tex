...
\drawCurrentPictureInMargin
\problem[2]{S}{i}{desde cualquier punto (\drawPointL[middle][DE]{D}) dentro de un triangulo \drawLine[bottom]{CA,EC,BE,AB} se trazan lineas rectas a los extremos de uno de los lados (\drawSizedLine{AB}), las lineas estarán más cercanas a los otros dos lados, y contendrán un angulo mayor.}
