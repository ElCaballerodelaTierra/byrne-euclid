...
$\because \drawUnitLine{CA} = \drawUnitLine{AD}$ \byref{ax:I.I,\hypref} y \byref{\constref}\\ %because
...
\drawCurrentPictureInMargin
\problem{S}{i}{un triángulo tiene dos lados (\drawUnitLine[0.7cm]{AB} y \drawUnitLine[0.7cm]{CA}) respectivamente iguales a dos lados (\drawUnitLine{DE} y \drawUnitLine{FD}) de otro triángulo, pero con bases diferentes, el ángulo creado por la base mayor (\drawUnitLine{BC}), debe ser mayor que el ángulo creado por la base menor (\drawUnitLine{EF}).}
...
\problem{S}{i}{dos triángulos tienen dos ángulos respectivamente iguales entre si ($\drawAngle{A} = \drawAngle{D}$ y $\drawAngle{B} = \drawAngle{GED,FEG}$), y un lado de uno es igual a un lado del otro, los lados y ángulos restantes son respectivamente iguales entre sí.}
\drawCurrentPictureInMargin
...
Supongamos que los ángulos alternos \drawAngle{IEA,HEI} y \drawAngle{GFD} no son iguales, trazamos \drawUnitLine{IE}, haciendo que $\drawAngle{HEI} = \drawAngle{GFD}$ \byref{prop:I.XXIII}.
...
y como \drawUnitLine{AD} es común a los dos triángulos;
...
\drawCurrentPictureInMargin
\problem{L}{os}{lados opuestos y ángulos de cualquier paralelogramo son iguales, y la diagonal (\drawUnitLine{AD}) lo divide en dos partes iguales.}
...
Por lo tanto, los lados opuestos y los ángulos de cualquier paralelogramo son iguales: y como los triángulos \drawLine{AD,CD,AC} y \drawLine{AB,BD,AD} son iguales en todo sentido \byref{prop:I.IV}, la diagonal divide al paralelogramo en dos partes iguales.
