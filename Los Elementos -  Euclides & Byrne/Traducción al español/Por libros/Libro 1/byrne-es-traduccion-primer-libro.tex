...
\begin{center}
\drawCurrentPictureInMargin Un círculo es una figura plana, delimitada por una línea continua, llamada circunferencia; dentro de él tiene un punto desde el cual todas las líneas rectas dibujadas a su circunferencia son iguales.
\end{center}
...
\begin{center}
\drawCurrentPictureInMargin Un semicírculo es la figura contenida por el diámetro, y la parte del círculo delimitada por el diámetro.
\end{center}
